...
export default function UseCasesSection() {
  ...
  return (
    <section ref={ref} className="relative w-full py-24 md:py-32 bg-[#050505] overflow-hidden border-t border-white/5">
      {/* Background Orbs */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Header */}
        <div 
          className="max-w-3xl mb-16 md:mb-24 transition-all duration-700 ease-out"
          style={{ 
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-display font-medium text-white leading-tight tracking-tight break-words hyphens-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {useCases.map((useCase, index) => (
            <div 
              key={index}
              className={`group relative p-8 md:p-10 rounded-3xl bg-gradient-to-b from-[#111111] to-[#0a0a0a] border border-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden flex flex-col justify-between min-h-[280px] sm:min-h-[320px] lg:min-h-[400px] mt-0 ${useCase.offset}`}
              style={{
                opacity: isVisible ? 1 : 0,
            ...
            >
              ...
              {/* Bottom Action */}
              <div className="relative z-10 mt-12 flex items-center text-xs font-semibold uppercase tracking-wider text-white/40 group-hover:text-white transition-colors duration-300">
