...
export default function CoreCapabilities() {
  ...
  return (
    <section ref={ref} className="relative py-24 px-6 bg-[#0a0a0a] overflow-hidden z-10">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        
        <h2 className={`text-2xl md:text-3xl font-display font-medium text-white/80 mb-16 text-center transition-all duration-700 transform ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {capabilities.map((cap, index) => {
            ...
            return (
              <div 
                key={index}
                className={`flex flex-col items-start p-10 rounded-2xl bg-[#111111] border border-white/5 border-t-cyber-blue/50 shadow-[0_0_30px_rgba(0,240,255,0.02)] transition-all duration-700 transform hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(0,240,255,0.05)] ${cap.delay} ${
